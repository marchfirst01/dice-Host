    ...
    initialData && (
      <PopUpDetailLayout>
        ...
        <section className="flex flex-col gap-4">
          ...
          <p
            className={`${isDescriptionDetailView ? '' : 'line-clamp-3'} text-style-BODY1 w-full text-deep_gray`}
          >
            {initialData.details}
          </p>
        ...
        <section className="flex flex-col gap-4">
          ...
          <div
            className={`text-style-BODY1 flex flex-col gap-1 whitespace-pre-line text-deep_gray`}
          >
